...
void multicore_launch_core1_with_stack(void (*entry)(void), uint32_t *stack_bottom, size_t stack_size_32bit) {
    uint32_t *stack_ptr = stack_bottom + stack_size_32bit;
...
void multicore_launch_core1(void (*entry)(void)) {
    extern uint32_t __stack1_bottom, __stack1_top;
    multicore_launch_core1_with_stack(entry, (uint32_t *) &__stack1_bottom, &__stack1_top - &__stack1_bottom);
}
